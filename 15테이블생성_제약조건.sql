...
CREATE TABLE DEPT2 (
             ...
             DAPT_NAME VARCHAR2(20), --최대 20바이트, 가변문자형
             DEPT_YN CHAR(1), --1BYTE 고정문자형
             DAPT_DATE DATE,
             DEPT_BONUS NUMBER(10,3) --10자리, 소수 3자리
);
DESC DEPT2;
...
--테이블 삭제
DROP TABLE DEPT2;
--DROP TABLE DEPT2 CASCADE 제약조건명; --제약조건FK도 삭제, 테이블도 삭제. 알아만두고 쓰면 안됨!
...
CREATE TABLE DEPTS2(
    DEPT_NO NUMBER(2),       
    DEPT_NAME VARCHAR2(20)  NOT NULL, --테이블 레벨 제약 안됨  
    DEPT_DATE DATE          DEFAULT SYSDATE, --제약조건X (컬럼의 기본값)          
...
--제약조건은 수정이 없음
ALTER TABLE DEPTS2 ADD PRIMARY KEY (DEPT_NO);
...
--NOT NULL은 MODIFY문장으로 수정합니다.
ALTER TABLE DEPTS2 MODIFY DEPTS2 MODIFY DEPT_NAME VARCHAR(20) NOT NULL;
...
DEPT_BONUS NUMBER(10),
LOCA NUMBER(4),
CONSTRAINT DEPTS_PK PRIMARY KEY (DEPT_NO) ENABLE);
